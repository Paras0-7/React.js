...
export const Cart = function(){
    ...
    const totalPrice =  totalAmount + 5.00 + 7.50;
    ...
    return(
        <div className={styles.cart}>
            ...
            {totalAmount === 0 && <h2 className={styles.empty}>Your Cart is empty. Add your favourite books!!! Hurry up</h2>}
            {totalAmount >0 && <div className={styles.total}>
                <h1>Payment Info</h1>
